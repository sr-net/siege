...
import type * as edgedb from "gel";
...
export type EnhancedObject = $default.EnhancedObject;
export type Author = $default.Author;
export type AuthorKind = $default.AuthorKind;
export type Gamemode = $default.Gamemode;
export type Like = $default.Like;
export type Report = $default.Report;
export type Strat = $default.Strat;
...
export namespace sys {
  ...
  export interface Role
    extends SystemObject, schema.InheritingObject, schema.AnnotationSubject {
    name: string;
    superuser: boolean;
...
export interface types {
  ...
  default: {
    EnhancedObject: $default.EnhancedObject;
    Author: $default.Author;
    AuthorKind: $default.AuthorKind;
