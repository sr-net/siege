...
export interface EnhancedObject extends std.$Object {
  createdAt: Date
}
export interface Author extends EnhancedObject {
  name: string
  kind: AuthorKind
  url?: string | null
  strats: Strat[]
...
export interface Like extends EnhancedObject {
  sessionId: string
  strat: Strat
  active?: boolean | null
}
export interface Report extends EnhancedObject {
  sessionId: string
  strat: Strat
  message?: string | null
}
export interface Strat extends EnhancedObject {
  gamemodes: Gamemode[]
  atk: boolean
  def: boolean
  submission: boolean
